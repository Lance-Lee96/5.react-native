...
const uploadImage = async uri => {
    ...
    //Firebase의 Storage 인스턴스를 가져오고, 저장할 파일의 참조를 생성
    const storage = getStorage(app);
    const storageRef = ref(storage, `/profile/${uid}/signup.png`);

    //지정한 참조에 blob 데이터를 image/png 형식으로 업로드
